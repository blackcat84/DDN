...
>>>>>>> effa9c2743fa931614bbb805584fcc6f20bbc85a
...
def multiscale_test_mg(model, test_loader, epoch, save_dir):
    ...
    scale = [0.5, 0.75, 1.0, 1.25, 1.5, 1.75]
<<<<<<< HEAD
    granus = [-5,-4.5,-4,-3.5,-3, -2.5, -2, -1.5, -1,-0.5, 0]
=======
