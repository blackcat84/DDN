...
The ckpt is the result I reproduced on another device (ODS=0.840), which is 0.1% lower than the accuracy reported in the paper (ODS=0.841). I think this kind of error is acceptable
